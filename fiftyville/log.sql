...
WHERE account_number IN (SELECT  FROM atm_transactions WHERE atm_location = "Leggett Street" AND  day = 28 AND month = 7 AND year = 2021 AND transaction_type = "withdraw");