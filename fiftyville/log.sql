...
SELECT person_id FROM bank_accounts WHERE bank_accounts IN (SELECT id FROM atm_transactions WHERE atm_location = "Leggett Street" AND  day = 28 AND month = 7 AND year = 2021 AND transaction_type = "withdraw")