...
person *create_family(int generations)
{
    ...
    if (generations > 1)
    {
        ...
        //new_p->alleles[0] = random_allele(new_p->parents[0]->alleles[0], new_p->parents[1]->alleles[1]);
       // new_p->alleles[1] = random_allele(new_p->parents[0]->alleles[0], new_p->parents[1]->alleles[1]);
